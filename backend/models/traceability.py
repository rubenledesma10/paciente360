...
class Traceability(db.Model):
    ...
    # id_product = db.Column(db.Integer, db.ForeignKey('medical_product.id_product'), nullable=False)  #  activamos cuando exista MedicalProduct
    ...
    # product = db.relationship('MedicalProduct', back_populates='traceabilities')  # activamos cuando exista MedicalProduct

    def to_dict(self):
        return {
            'id_traceability': self.id_traceability,
            'id_patient': self.id_patient,
            # 'id_product': self.id_product,   # activamos cuando exista MedicalProduct
